...
const EditEmailModal: React.FC<EditEmailModalProps> = ({ user, onUpdateUser, onClose }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const { success, message } = await onUpdateUser({ email }, password);
        setIsLoading(false);
            ...
            <div className="bg-white dark:bg-slate-800 rounded-lg shadow-xl w-full max-w-md">
                <form onSubmit={handleSubmit} className="p-6">
                    <div className="flex justify-between items-center mb-4">
                        <h2 className="text-xl font-bold text-slate-800 dark:text-slate-100">Edit Email</h2>
                    ...
                    <div className="mb-4">
                        <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1" htmlFor="edit-email">
                            New Email
                        </label>
                        <input
                            type="email"
                    ...
                    <div className="mb-4">
                        <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1" htmlFor="current-password-email">
