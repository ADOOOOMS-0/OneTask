  ...
  >
    <defs>
      <linearGradient id="logoGradient" x1="0%" y1="100%" x2="100%" y2="0%">
        <stop offset="0%" stopColor="#08335E" />
        <stop offset="50%" stopColor="#157291" />
...
export const CogIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || 'w-6 h-6'}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12a7.5 7.5 0 0 0 15 0m-15 0a7.5 7.5 0 1 1 15 0m-15 0H3m18 0h-1.5m-15 0H3.75m16.5 0h-1.5m-15 0H3.75m16.5 0h-1.5m-15 0H3.75m16.5 0h-1.5M12 6.75v-1.5m0 10.5v1.5m-3.375-8.25L5.25 4.5m13.5 13.5L18.75 15m-13.5 0L5.25 19.5m13.5-13.5L18.75 9" />
    </svg>
);
